...
public class CallNumberTypeMigrationService extends AsyncBaseMigrationService {
  ...
  protected CallNumberTypeMigrationService(Context context, Map<String, String> okapiHeaders) {
